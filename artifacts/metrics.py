...
Используется во всех ноутбуках 04-08 для модулей оценки.

По §7 инструкции выход: dict из 12 ключей.
- y_true: array-like с 0/1
- y_pred: array-like с 0/1 (бинарные предсказания после порога)
- y_score: array-like с непрерывными оценками для AUC (predict_proba[:, 1]
           или recon-error для autoencoder). Если None — AUC = NaN.
"""
